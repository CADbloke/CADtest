...
Namespace Helpers
  Public Class DbEntity
    ...
    Public Shared Function AddToModelSpace(Of T As Entity)(entities As List(Of T), database As Database) As ObjectIdCollection
      ...
      Using transaction As Transaction = transactionManager.StartTransaction()
        Dim blockTable As BlockTable = DirectCast(transactionManager.GetObject(database.BlockTableId, OpenMode.ForRead, False), BlockTable)
        Dim modelSpace As BlockTableRecord = DirectCast(transactionManager.GetObject(blockTable(BlockTableRecord.ModelSpace), OpenMode.ForWrite, False), BlockTableRecord)
