...
namespace CADtest.Helpers
{
  public class DbEntity // source unknown but probably http://www.theswamp.org/index.php?action=profile;u=935
  {
   ...
   { 
     ...
     {
       BlockTable blockTable = (BlockTable) transactionManager.GetObject(database.BlockTableId, OpenMode.ForRead, false);
       BlockTableRecord modelSpace = (BlockTableRecord) transactionManager
         .GetObject(blockTable[BlockTableRecord.ModelSpace], OpenMode.ForWrite, false);
